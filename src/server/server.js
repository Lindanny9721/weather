...
app.get('/data', (req, res, next) => {
  ...
  const API_URL = `https://api.openweathermap.org/data/2.5/weather?q=${location}&appid=API KEY&units=imperial`
...
app.get('/days', (req, res) => {
  const location = req.query.location
  const API_URL = `http://api.openweathermap.org/data/2.5/forecast?q=${location}&appid=API KEY&units=imperial`
